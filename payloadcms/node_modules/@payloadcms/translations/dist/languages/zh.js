export const zhTranslations = {
    authentication: {
        ...
        changePassword: '更改密码',
        checkYourEmailForPasswordReset: '如果此电子邮件地址已关联到一个账户，你将会很快收到重置密码的说明。如果你在收件箱中看不到此电子邮件，请检查你的垃圾邮件或垃圾邮件夹。',
    ...
    folder: {
        ...
        moveFolder: '移动文件夹',
        moveItemsToFolderConfirmation: '您即将将<1>{{count}} {{label}}</1>移动到<2>{{toFolder}}</2>.您确定吗？',
