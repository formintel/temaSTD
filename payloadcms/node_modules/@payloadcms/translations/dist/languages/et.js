export const etTranslations = {
    authentication: {
        ...
        checkYourEmailForPasswordReset: 'Kui e-posti aadress on kontoga seotud, saate varsti juhised parooli lähtestamiseks. Kui te ei näe e-kirja postkastis, kontrollige rämpsposti kausta.',
        ...
        forgotPasswordEmailInstructions: 'Palun sisesta oma e-posti aadress. Saadame sulle e-kirja juhistega parooli lähtestamiseks.',
        forgotPasswordQuestion: 'Unustasid parooli?',
        forgotPasswordUsernameInstructions: 'Palun sisesta oma kasutajanimi. Saadame parooli lähtestamise juhised sinu kasutajanimega seotud e-posti aadressile.',
        generate: 'Genereeri',
        generateNewAPIKey: 'Genereeri uus API võti',
        generatingNewAPIKeyWillInvalidate: 'Uue API võtme genereerimine <1>tühistab</1> eelmise võtme. Kas soovid jätkata?',
        ...
        newAccountCreated: 'Teile on loodud uus konto juurdepääsuks <a href="{{serverURL}}">{{serverURL}}</a> Palun klõpsake järgmisel lingil või kopeerige URL brauserisse oma e-posti kinnitamiseks: <a href="{{verificationURL}}">{{verificationURL}}</a><br> Pärast e-posti kinnitamist saate edukalt sisse logida.',
        ...
        youAreInactive: 'Te pole mõnda aega aktiivne olnud ja teid logitakse peagi teie turvalisuse huvides automaatselt välja. Kas soovite jääda sisselogituks?',
        youAreReceivingResetPassword: 'Saite selle kirja, kuna teie (või keegi teine) on taotlenud teie konto parooli lähtestamist. Protsessi lõpuleviimiseks klõpsake järgmisel lingil või kopeerige see brauserisse:',
        youDidNotRequestPassword: 'Kui te seda ei taotlenud, ignoreerige seda e-kirja ja teie parool jääb muutmata.'
    },
    error: {
        ...
        deletingTitle: '{{title}} kustutamisel tekkis viga. Palun kontrollige ühendust ja proovige uuesti.',
        ...
        unableToReindexCollection: 'Viga kollektsiooni {{collection}} taasindekseerimisel. Toiming katkestatud.',
    ...
    fields: {
        ...
        chooseBetweenCustomTextOrDocument: 'Vali kohandatud teksti URL-i või teise dokumendiga linkimise vahel.',
    ...
    folder: {
        ...
        moveItemsToFolderConfirmation: 'Te olete umbes kolimas <1>{{count}} {{label}}</1> kausta <2>{{toFolder}}</2>. Kas olete kindel?',
        moveItemsToRootConfirmation: 'Te olete peaaegu teisaldamas <1>{{count}} {{label}}</1> juurkausta. Kas olete kindel?',
        moveItemToFolderConfirmation: 'Te olete umbes liigutamas <1>{{title}}</1> kausta <2>{{toFolder}}</2>. Kas olete kindel?',
        moveItemToRootConfirmation: 'Te olete peaaegu liigutanud <1>{{title}}</1> juurkausta. Kas olete kindel?',
    ...
    general: {
        ...
        currentlyEditing: 'muudab praegu seda dokumenti. Kui võtate üle, blokeeritakse neil muutmise jätkamine ja nad võivad kaotada salvestamata muudatused.',
        custom: 'Kohandatud',
        dark: 'Tume',
        dashboard: 'Töölaud',
        delete: 'Kustuta',
        ...
        successfullyReindexed: 'Edukalt indekseeritud {{count}} {{total}}-st dokumendist kollektsioonides {{collections}}',
        takeOver: 'Võta üle',
        thisLanguage: 'Eesti',
        time: 'Aeg',
        timezone: 'Ajavöönd',
    ...
    upload: {
        ...
        crop: 'Kärbi',
        cropToolDescription: 'Lohista valitud ala nurki, joonista uus ala või kohanda väärtusi allpool.',
    ...
    validation: {
        ...
        username: 'Palun sisesta kehtiv kasutajanimi. Võib sisaldada tähti, numbreid, sidekriipse, punkte ja alakriipse.',
    ...
    version: {
        ...
        aboutToRestore: 'Olete taastamas seda {{label}} dokumenti seisundisse, milles see oli {{versionDate}}.',
        aboutToRestoreGlobal: 'Olete taastamas globaalset {{label}} seisundisse, milles see oli {{versionDate}}.',
        aboutToRevertToPublished: 'Olete taastamas selle dokumendi muudatusi avaldatud seisundisse. Olete kindel?',
