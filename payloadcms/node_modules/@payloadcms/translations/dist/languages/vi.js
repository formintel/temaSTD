export const viTranslations = {
    authentication: {
        ...
        checkYourEmailForPasswordReset: 'Nếu địa chỉ email được liên kết với một tài khoản, bạn sẽ nhận được hướng dẫn để đặt lại mật khẩu trong thời gian ngắn. Vui lòng kiểm tra thư mục spam hoặc thư rác nếu bạn không thấy email trong hộp thư đến của mình.',
    ...
    error: {
        ...
        unableToReindexCollection: 'Lỗi khi tái lập chỉ mục bộ sưu tập {{collection}}. Quá trình bị hủy.',
    ...
    folder: {
        ...
        moveItemsToFolderConfirmation: 'Bạn sắp chuyển <1>{{count}} {{label}}</1> tới <2>{{toFolder}}</2>. Bạn có chắc chắn không?',
        moveItemsToRootConfirmation: 'Bạn đang chuẩn bị di chuyển <1>{{count}} {{label}}</1> đến thư mục gốc. Bạn có chắc không?',
        moveItemToFolderConfirmation: 'Bạn sắp chuyển <1>{{title}}</1> đến <2>{{toFolder}}</2>. Bạn có chắc không?',
        moveItemToRootConfirmation: 'Bạn đang chuẩn bị di chuyển <1>{{title}}</1> đến thư mục gốc. Bạn có chắc chắn không?',
    ...
    general: {
        ...
        confirmReindexDescription: 'Điều này sẽ xóa các chỉ mục hiện tại và tái lập chỉ mục các tài liệu trong các bộ sưu tập {{collections}}.',
        confirmReindexDescriptionAll: 'Điều này sẽ xóa các chỉ mục hiện tại và tái lập chỉ mục các tài liệu trong tất cả các bộ sưu tập.',
        copied: 'Đâ sao chép',
        copy: 'Sao chép',
        copying: 'Sao chép',
        copyWarning: 'Bạn đang chuẩn bị ghi đè {{to}} bằng {{from}} cho {{label}} {{title}}. Bạn có chắc chắn không?',
        create: 'Tạo',
        created: 'Đã tạo',
        createdAt: 'Ngày tạo',
        createNew: 'Tạo mới',
        ...
        currentlyEditing: 'hiện đang chỉnh sửa tài liệu này. Nếu bạn tiếp quản, họ sẽ bị chặn tiếp tục chỉnh sửa và cũng có thể mất các thay đổi chưa lưu.',
        custom: 'Tùy chỉnh',
        dark: 'Nền tối',
        ...
        move: 'Di chuyển',
        moveConfirm: 'Bạn sắp chuyển {{count}} {{label}} đến <1>{{destination}}</1>. Bạn có chắc chắn không?',
        ...
        successfullyReindexed: 'Tái lập chỉ mục thành công {{count}} trong tổng số {{total}} tài liệu từ {{collections}} bộ sưu tập.',
        takeOver: 'Tiếp quản',
    ...
    validation: {
        ...
        username: 'Vui lòng nhập một tên người dùng hợp lệ. Có thể chứa các chữ cái, số, dấu gạch ngang, dấu chấm và dấu gạch dưới.',
