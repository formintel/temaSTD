export const nlTranslations = {
    authentication: {
        ...
        checkYourEmailForPasswordReset: 'Als het e-mailadres is gekoppeld aan een account, ontvangt u binnenkort instructies om uw wachtwoord opnieuw in te stellen. Controleer uw spam- of ongewenste e-mailmap als u de e-mail niet in uw inbox ziet.',
    ...
    error: {
        ...
        unableToReindexCollection: 'Fout bij het herindexeren van de collectie {{collection}}. De operatie is afgebroken.',
        ...
        unauthorizedAdmin: 'Ongeautoriseerd, deze gebruiker heeft geen toegang tot het beheerderspaneel.',
    ...
    folder: {
        ...
        moveItemsToFolderConfirmation: 'U staat op het punt om <1>{{count}} {{label}}</1> te verplaatsen naar <2>{{toFolder}}</2>. Weet u het zeker?',
        moveItemsToRootConfirmation: 'U staat op het punt om <1>{{count}} {{label}}</1> naar de hoofdmap te verplaatsen. Weet u het zeker?',
        moveItemToFolderConfirmation: 'U staat op het punt om <1>{{title}}</1> te verplaatsen naar <2>{{toFolder}}</2>. Weet u het zeker?',
        moveItemToRootConfirmation: 'U staat op het punt om <1>{{title}}</1> naar de hoofdmap te verplaatsen. Weet u het zeker?',
    ...
    general: {
        ...
        copy: 'Kopiëren',
        copying: 'Kopiëren',
        copyWarning: 'U staat op het punt om {{to}} te overschrijven met {{from}} voor {{label}} {{title}}. Bent u zeker?',
        create: 'Aanmaken',
        created: 'Aangemaakt',
        ...
        currentlyEditing: 'is momenteel dit document aan het bewerken. Als je het overneemt, wordt voorkomen dat ze doorgaan met bewerken en kunnen ze ook niet-opgeslagen wijzigingen verliezen.',
        custom: 'Aangepast',
        dark: 'Donker',
        dashboard: 'Dashboard',
        delete: 'Verwijderen',
        ...
        move: 'Verplaatsen',
        moveConfirm: 'U staat op het punt om {{count}} {{label}} te verplaatsen naar <1>{{destination}}</1>. Weet u het zeker?',
        ...
        successfullyReindexed: 'Succesvol {{count}} van {{total}} documenten uit {{collections}} collecties herindexeerd.',
        takeOver: 'Overnemen',
    ...
    validation: {
        ...
        username: 'Voer een geldige gebruikersnaam in. Kan letters, cijfers, koppeltekens, punten en underscores bevatten.',
