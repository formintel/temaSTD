export const skTranslations = {
    authentication: {
        ...
        checkYourEmailForPasswordReset: 'Ak je e-mailová adresa spojená s účtom, čoskoro dostanete inštrukcie na obnovenie hesla. Skontrolujte prosím svoju spamovú alebo junk mail zložku, ak e-mail nevidíte vo svojej doručenej pošte.',
    ...
    error: {
        ...
        unableToReindexCollection: 'Chyba pri reindexácii kolekcie {{collection}}. Operácia bola prerušená.',
        ...
        unauthorizedAdmin: 'Neoprávnený prístup, tento používateľ nemá prístup k administrátorskému panelu.',
    ...
    folder: {
        ...
        moveItemsToFolderConfirmation: 'Chystáte sa presunúť <1>{{count}} {{label}}</1> do <2>{{toFolder}}</2>. Ste si istý?',
        moveItemsToRootConfirmation: 'Chystáte sa presunúť <1>{{count}} {{label}}</1> do koreňového priečinka. Ste si istý?',
        moveItemToFolderConfirmation: 'Chystáte sa presunúť <1>{{title}}</1> do <2>{{toFolder}}</2>. Ste si istý?',
        moveItemToRootConfirmation: 'Chystáte sa presunúť <1>{{title}}</1> do koreňového priečinka. Ste si istý?',
    ...
    general: {
        ...
        confirmReindexDescription: 'Týmto sa odstránia existujúce indexy a znova sa zaindexujú dokumenty v kolekciách {{collections}}.',
        confirmReindexDescriptionAll: 'Týmto sa odstránia existujúce indexy a znova sa zaindexujú dokumenty vo všetkých kolekciách.',
        copied: 'Skopírované',
        copy: 'Kopírovať',
        copying: 'Kopírovanie',
        ...
        currentlyEditing: 'práve upravuje tento dokument. Ak prevezmete kontrolu, budú zablokovaní z pokračovania v úpravách a môžu tiež stratiť neuložené zmeny.',
        custom: 'Vlastný',
        dark: 'Tmavý',
        dashboard: 'Nástenka',
        delete: 'Odstrániť',
        ...
        successfullyReindexed: 'Úspešne bolo reindexovaných {{count}} z {{total}} dokumentov z kolekcií {{collections}}.',
        takeOver: 'Prevziať',
    ...
    validation: {
        ...
        username: 'Prosím, zadajte platné používateľské meno. Môže obsahovať písmená, čísla, pomlčky, bodky a podčiarknutia.',
