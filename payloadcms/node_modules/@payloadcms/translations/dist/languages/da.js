export const daTranslations = {
    authentication: {
        ...
        checkYourEmailForPasswordReset: 'Hvis e-mailadressen er forbundet med en konto, vil du kort tid modtage instruktioner til at nulstille din adgangskode. Tjek venligst din spam- eller junkmail-mappe, hvis du ikke ser e-mailen i din indbakke.',
        ...
        forgotPasswordEmailInstructions: 'Indtast email nedenunder. Du vil modtage en email med instruktioner i hvordan du nulstiller din adgangskode.',
        forgotPasswordQuestion: 'Glemt adgangskode?',
        forgotPasswordUsernameInstructions: 'Indtast brugernavn nedenunder. Instruktioner i hvordan du nulstiller din adgangskode vil blive sendt til den email der er tilknyttet brugeren.',
        generate: 'Generer',
        generateNewAPIKey: 'Generer ny API nøgle.',
        generatingNewAPIKeyWillInvalidate: 'Generering af en ny API nøgle vil <1>ugyldiggøre</1> den tidligere nøgle. Vil du forsætte?',
        ...
        newAccountCreated: 'En ny bruger er blevet oprettet. <a href="{{serverURL}}">{{serverURL}}</a> Klik på linket eller kopier URL for at verificere din email: <a href="{{verificationURL}}">{{verificationURL}}</a><br> Efter verificeringen af din email, kan du logge ind.',
        ...
        youAreInactive: 'Du har ikke været aktiv i et stykke tid og vil snart blive logget automatisk ud. Vil du forblive logget ind?',
        youAreReceivingResetPassword: 'Du modtager dette, fordi du eller en anden har anmodet om at nulstille adgangskoden til din konto. Klik venligst på følgende link, eller indsæt det i din browser for at fuldføre processen:',
        youDidNotRequestPassword: 'Hvis du ikke har anmodet om dette, skal du blot ignorere denne e-mail, og din adgangskode vil forblive uændret'
    },
    error: {
        ...
        unableToReindexCollection: 'Fejl ved genindeksering af samling {{collection}}. Operationen blev afbrudt.',
    ...
    fields: {
        ...
        blocks: 'blokke',
        blockType: 'Blok type',
        chooseBetweenCustomTextOrDocument: 'Vælg mellem at indtaste en brugerdefineret tekst-URL eller linke til et andet dokument.',
    ...
    folder: {
        ...
        moveItemsToFolderConfirmation: 'Du er ved at flytte <1>{{count}} {{label}}</1> til <2>{{toFolder}}</2>. Er du sikker?',
        moveItemsToRootConfirmation: 'Du er ved at flytte <1>{{count}} {{label}}</1> til rodmappen. Er du sikker?',
        moveItemToFolderConfirmation: 'Du er ved at flytte <1>{{title}}</1> til <2>{{toFolder}}</2>. Er du sikker?',
    ...
    general: {
        ...
        cancel: 'Anuller',
        changesNotSaved: 'Dine ændringer er ikke blevet gemt. Hvis du forlader siden, vil din ændringer gå tabt.',
        clearAll: 'Ryd alt',
        close: 'Luk',
        collapse: 'Skjul',
        ...
        copy: 'Kopier',
        copying: 'Kopiering',
        copyWarning: 'Du er lige ved at overskrive {{to}} med {{from}} for {{label}} {{title}}. Er du sikker?',
        create: 'Opret',
        created: 'Oprettet',
        ...
        move: 'Flyt',
        moveConfirm: 'Du er ved at flytte {{count}} {{label}} til <1>{{destination}}</1>. Er du sikker?',
        ...
        successfullyReindexed: '{{count}} ud af {{total}} dokumenter fra {{collections}} samlinger blev genindekseret med succes.',
        takeOver: 'Overtag',
        thisLanguage: 'Dansk',
        time: 'Tid',
        timezone: 'Tidszone',
    ...
    upload: {
        ...
        crop: 'Beskær',
        cropToolDescription: 'Træk i hjørnerne af det valgte område, tegn et nyt område eller juster værdierne nedenfor.',
        download: 'Download',
        ...
        focalPointDescription: 'Træk fokuspunktet direkte på forhåndsvisningen eller juster værdierne nedenfor.',
        height: 'Højde',
    ...
    validation: {
        ...
        username: 'Indtast et brugernavn. Kan indeholde bogstaver, tal, bindestreger, punktum og underscores.',
        validUploadID: 'Dette felt er ikke en gyldig upload-ID.'
    },
    version: {
        type: 'Type',
        aboutToPublishSelection: 'Du er ved at offentliggøre alt {{label}} i denne sektion. Er du sikker?',
        aboutToRestore: 'Du er ved at gendanne dette {{label}} dokument til den tilstand, det var i den {{versionDate}}.',
