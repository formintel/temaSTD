export const csTranslations = {
    authentication: {
        ...
        checkYourEmailForPasswordReset: 'Pokud je e-mailová adresa spojena s účtem, brzy obdržíte pokyny k resetování vašeho hesla. Pokud e-mail nenajdete ve vaší doručené poště, zkontrolujte prosím složku se spamem nebo nevyžádanou poštou.',
    ...
    error: {
        ...
        unableToReindexCollection: 'Chyba při přeindexování kolekce {{collection}}. Operace byla přerušena.',
    ...
    folder: {
        ...
        moveItemsToFolderConfirmation: 'Chystáte se přesunout <1>{{count}} {{label}}</1> do <2>{{toFolder}}</2>. Jste si jistý?',
        moveItemsToRootConfirmation: 'Chystáte se přesunout <1>{{count}} {{label}}</1> do kořenové složky. Jste si jisti?',
        moveItemToFolderConfirmation: 'Chystáte se přesunout <1>{{title}}</1> do <2>{{toFolder}}</2>. Jste si jistý?',
        moveItemToRootConfirmation: 'Chystáte se přesunout <1>{{title}}</1> do kořenové složky. Jste si jistý?',
    ...
    general: {
        ...
        currentlyEditing: 'právě upravuje tento dokument. Pokud převezmete kontrolu, budou zablokováni v pokračování úprav a mohou také přijít o neuložené změny.',
        custom: 'Vlastní',
        dark: 'Tmavý',
        dashboard: 'Nástěnka',
        delete: 'Odstranit',
        ...
        move: 'Pohnout',
        moveConfirm: 'Chystáte se přesunout {{count}} {{label}} do <1>{{destination}}</1>. Jste si jisti?',
        ...
        successfullyReindexed: 'Úspěšně přeindexováno {{count}} z {{total}} dokumentů z {{collections}} kolekcí.',
        takeOver: 'Převzít',
    ...
    validation: {
        ...
        username: 'Prosím, zadejte platné uživatelské jméno. Může obsahovat písmena, čísla, pomlčky, tečky a podtržítka.',
