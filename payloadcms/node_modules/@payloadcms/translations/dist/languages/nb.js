export const nbTranslations = {
    authentication: {
        ...
        checkYourEmailForPasswordReset: 'Hvis e-postadressen er knyttet til en konto, vil du motta instruksjoner for å tilbakestille passordet ditt snart. Vennligst sjekk spam- eller søppelpost-mappen din hvis du ikke ser e-posten i innboksen din.',
    ...
    error: {
        ...
        unableToReindexCollection: 'Feil ved reindeksering av samlingen {{collection}}. Operasjonen ble avbrutt.',
    ...
    folder: {
        ...
        moveItemsToFolderConfirmation: 'Du er i ferd med å flytte <1>{{count}} {{label}}</1> til <2>{{toFolder}}</2>. Er du sikker?',
        moveItemsToRootConfirmation: 'Du er i ferd med å flytte <1>{{count}} {{label}}</1> til rotmappen. Er du sikker?',
        moveItemToFolderConfirmation: 'Du er i ferd med å flytte <1>{{title}}</1> til <2>{{toFolder}}</2>. Er du sikker?',
        moveItemToRootConfirmation: 'Du er i ferd med å flytte <1>{{title}}</1> til rodmappen. Er du sikker?',
    ...
    general: {
        ...
        copy: 'Kopiér',
        copying: 'Kopiering',
        copyWarning: 'Du er i ferd med å overskrive {{to}} med {{from}} for {{label}} {{title}}. Er du sikker?',
        create: 'Opprett',
        created: 'Opprettet',
        createdAt: 'Opprettet',
        ...
        currentlyEditing: 'redigerer for øyeblikket dette dokumentet. Hvis du tar over, blir de blokkert fra å fortsette å redigere, og de kan også miste ulagrede endringer.',
        custom: 'Tilpasset',
        dark: 'Mørk',
        ...
        move: 'Flytt',
        moveConfirm: 'Du er i ferd med å flytte {{count}} {{label}} til <1>{{destination}}</1>. Er du sikker?',
        ...
        successfullyReindexed: 'Vellykket reindeksering av {{count}} av {{total}} dokumenter fra {{collections}} samlinger.',
        takeOver: 'Ta over',
        thisLanguage: 'Norsk',
        time: 'Tid',
        timezone: 'Tidssone',
    ...
    validation: {
        ...
        username: 'Vennligst oppgi et gyldig brukernavn. Kan inneholde bokstaver, nummer, bindestreker, punktum og understrek.',
